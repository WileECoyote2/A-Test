...
struct  ThreadSafeDictionary_2_t875  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t874 * ____valueFactory_1;
	...
	Dictionary_2_t2998 * ____dictionary_2;
};
