...
struct  X509Store_t1603  : public Object_t
{
	...
	X509Certificate2Collection_t1597 * ___list_2;
	...
	X509Store_t1348 * ___store_4;
};
struct X509Store_t1603_StaticFields{
	...
	Dictionary_2_t239 * ___U3CU3Ef__switchU24mapF_5;
};
