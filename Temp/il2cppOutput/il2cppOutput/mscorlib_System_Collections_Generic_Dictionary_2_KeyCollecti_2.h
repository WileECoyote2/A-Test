...
struct  KeyCollection_t2542  : public Object_t
{
	// System.Collections.Generic.Dictionary`2<TKey,TValue> System.Collections.Generic.Dictionary`2/KeyCollection<Pathfinding.GraphNode,Pathfinding.NodeLink2>::dictionary
