...
struct  ServicePointManager_t1453  : public Object_t
{
};
struct ServicePointManager_t1453_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1481 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1462 * ___server_cert_cb_9;
};
