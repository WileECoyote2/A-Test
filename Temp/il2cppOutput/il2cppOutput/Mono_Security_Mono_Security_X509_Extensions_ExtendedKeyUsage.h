...
struct  ExtendedKeyUsageExtension_t1353  : public X509Extension_t1347
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1313 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1353_StaticFields{
	...
	Dictionary_2_t239 * ___U3CU3Ef__switchU24map14_4;
};
