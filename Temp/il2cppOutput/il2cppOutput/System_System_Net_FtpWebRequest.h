...
struct  FtpWebRequest_t1573  : public WebRequest_t1465
{
	...
	RemoteCertificateValidationCallback_t1462 * ___callback_15;
};
struct FtpWebRequest_t1573_StaticFields{
	...
	RemoteCertificateValidationCallback_t1462 * ___U3CU3Ef__amU24cache1C_16;
};
