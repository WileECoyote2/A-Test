...
struct  ClientSessionInfo_t1375  : public Object_t
{
	...
	ByteU5BU5D_t29* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t29* ___masterSecret_5;
};
struct ClientSessionInfo_t1375_StaticFields{
