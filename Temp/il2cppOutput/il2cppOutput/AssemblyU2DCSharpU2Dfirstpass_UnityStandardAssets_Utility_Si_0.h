...
struct  SimpleMouseRotator_t362  : public MonoBehaviour_t3
{
	// UnityEngine.Vector2 UnityStandardAssets.Utility.SimpleMouseRotator::rotationRange
	Vector2_t189  ___rotationRange_2;
